...
const DetailArticle = () => {
  ...
  return (
    <main className="flex flex-col justify-center items-center mt-20">
      ...
      <div className="container flex flex-col justify-center items-center text-justify gap-10">
      {article ? (
      ...
      <button className="w-[200px] h-[50px] border-4 rounded-full bg-black text-white mb-10" onClick={() => navigate(-1)}>Back to Articles</button>
      </div>
    </main>
  );
};
